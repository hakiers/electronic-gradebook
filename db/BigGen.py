...
class DataGenerator:
    ...
    def generate_class_profiles(self):
        ...
        profiles = [
            ...
            ('1C', 'Klasa 1C - humanist'),
            ('1D', 'Klasa 1D - językowa'),
            ('2A', 'Klasa 2A'),
            ('2B', 'Klasa 2B - mat-przyr'),
            ('2C', 'Klasa 2C - humanist'),
            ('2D', 'Klasa 2D - językowa'),
            ('3A', 'Klasa 3A'),
            ('3B', 'Klasa 3B - mat-przyr'),
            ('3C', 'Klasa 3C - humanist'),
            ('3D', 'Klasa 3D - językowa'),
            ('4A', 'Klasa 4A'),
            ('4B', 'Klasa 4B - mat-przyr'),
            ('4C', 'Klasa 4C - humanist'),
            ('4D', 'Klasa 4D - językowa'),
            ('5A', 'Klasa 5A'),
            ('5B', 'Klasa 5B - mat-przyr'),
            ('5C', 'Klasa 5C - humanist'),
            ('5D', 'Klasa 5D - językowa')
        ]
    ...
    def generate_subjects(self):
        ...
        subjects = [
                ...
                'Wychowanie fizyczne', 'WOS', 'Język niemiecki', 'Język francuski',
                'Język hiszpański', 'Plastyka', 'Muzyka', 'Etyka', 'Filozofia',
                'Przedsiębiorczość', 'Edukacja dla bezpieczeństwa', 'Religia'
            ]
    ...
    def generate_classes(self, teachers_data):
        ...
        # 20 klas (indeksy 1-20)
        for i in range(1, 21):
            # Przypisanie wychowawcy (upewnij się, że teachers_data ma wystarczająco elementów)
    ...
    def generate_students_and_parents(self, classes_data):
        ...
        students_per_class = [20] * len(classes_data)
    ...
    def generate_schedule(self, classes_data, teachers_data):
        ...
        for group_id, class_id, subject_id, subject_name in groups_data:
            ...
            lessons_per_week = {
                ...
                'Język niemiecki': 2, 'Język francuski': 2, 'Język hiszpański': 2,
                'WOS': 2, 'Przedsiębiorczość': 2, 'Religia': 1, 'Etyka': 1,
                'Filozofia': 1, 'Plastyka': 1, 'Muzyka': 1
            }.get(subject_name, 2)
...
def main():
    ...
    print(f"- 20 klas")
    print(f"- 60 nauczycieli + 1 administrator")
    print(f"- ~600 uczniów")
    print(f"- ~900-1200 rodziców")
    print(f"- 15-20 przedmiotów")
